<?php get_header(); ?>
    ...
    <article role="main" class="primary-content single-paper" id="post-<?php the_ID(); ?>">
        ...
        <div class="content">
            <div class="paper-meta">
            	...
            	<span class="date"> - </i><?php echo get_the_date(); ?></span>
            ...
            <div class="actions">
                <?php if ( $pdf ) : ?>
            		<span class="download"><a class="btn btn-primary" href="<?php echo $pdf; ?>">Download</a></span>
            	<?php elseif ($url) : ?>
            		<span class="paper-url"><a class="btn btn-primary" href="<?php echo $url; ?>">View Paper</a></span>
            	<?php endif; ?>
            </div>
